...
/**
 ...
 @return Returns whether the send succeeded.
 */
+ (BOOL)sendPushMessageToQuery:(BEQuery<BEInstallation *> *)query withMessage:(NSString *)message error:(NSError **)error;
 ...
 *Synchronously* send a push message with arbitrary data to a query.
 ...
 @return Returns whether the send succeeded.
 */
+ (BOOL)sendPushDataToQuery:(BEQuery<BEInstallation *> *)query withData:(NSDictionary *)data error:(NSError **)error;
