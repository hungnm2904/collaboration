...
typedef void(^PFGeoPointResultBlock)(BEGeoPoint *_Nullable geoPoint, NSError *_Nullable error);
 ...
 */
@interface BEGeoPoint : NSObject <NSCopying, NSCoding>
 ...
 */
- (double)distanceInRadiansTo:(nullable BEGeoPoint *)point;
 ...
 */
- (double)distanceInMilesTo:(nullable BEGeoPoint *)point;
 ...
 */
- (double)distanceInKilometersTo:(nullable BEGeoPoint *)point;
