...
@class PFRelation<ObjectType : BEObject *>;
 ...
 */
@interface BERole : BEObject <BESubclassing>
 ...
 */
- (instancetype)initWithName:(NSString *)name acl:(nullable BEACL *)acl;
...
/**
 ...
 @param acl The ACL for this role. Roles must have an ACL.
 */
+ (instancetype)roleWithName:(NSString *)name acl:(nullable BEACL *)acl;
 ...
 */
@property (nonatomic, strong, readonly) PFRelation<BEUser *> *users;
 ...
 */
@property (nonatomic, strong, readonly) PFRelation<BERole *> *roles;
