...
@class BEQuery<PFGenericObject : BEObject *>;
 ...
 */
PF_TV_UNAVAILABLE PF_WATCH_UNAVAILABLE @interface BEPush : NSObject<NSCopying>
 ...
 */
- (void)setQuery:(nullable BEQuery<BEInstallation *> *)query;
 ...
 *Asynchronously* send a push message to a query.
 ...
 @return The task, that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)sendPushMessageToQueryInBackground:(BEQuery<BEInstallation *> *)query
 ...
 *Asynchronously* sends a push message to a query and calls the given block.
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`
 */
+ (void)sendPushMessageToQueryInBackground:(BEQuery<BEInstallation *> *)query
                               withMessage:(NSString *)message
...
/**
 ...
 @return The task, that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)sendPushDataToQueryInBackground:(BEQuery<BEInstallation *> *)query
                                               withData:(NSDictionary *)data;
 ...
 *Asynchronously* sends a push message with arbitrary data to a query and calls the given block.
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
+ (void)sendPushDataToQueryInBackground:(BEQuery<BEInstallation *> *)query
                               withData:(NSDictionary *)data
                                  block:(nullable PFBooleanResultBlock)block;
