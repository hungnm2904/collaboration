 ...
 */
@interface CSBMClientConfiguration : NSObject <NSCopying>
 ...
 */
+ (instancetype)configurationWithBlock:(void (^)(id<CSBMMutableClientConfiguration> configuration))configurationBlock;
