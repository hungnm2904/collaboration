 ...
 */
PF_OSX_UNAVAILABLE PF_TV_UNAVAILABLE PF_WATCH_UNAVAILABLE @interface BENetworkActivityIndicatorManager : NSObject
 ...
 */
+ (BENetworkActivityIndicatorManager *)sharedManager;
