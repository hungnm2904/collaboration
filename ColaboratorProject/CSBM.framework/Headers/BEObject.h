...
/**
 The name of the default pin that for BEObject local data store.
 */
extern NSString *const BEObjectDefaultPin;

/**
 The `BEObject` class is a local representation of data persisted to the Parse cloud.
 This is the main class that is used to interact with objects in your app.
 */
NS_REQUIRES_PROPERTY_DEFINITIONS
@interface BEObject : NSObject

///--------------------------------------
#pragma mark - Creating a BEObject
///--------------------------------------

/**
 Initializes a new empty `BEObject` instance with a class name.
...
/**
 Creates a new BEObject with a class name.
...
/**
 Creates a new `BEObject` with a class name, initialized with data
 constructed from the specified set of objects and keys.

 @param className The object's class.
 @param dictionary An `NSDictionary` of keys and objects to set on the new `BEObject`.

 @return A BEObject with the given class name and set with the given data.
 */
...
/**
 ...
 @return A `BEObject` instance without data.
 */
 ...
 */
@property (nullable, nonatomic, strong) BEACL *ACL;
...
/**
 ...
 @param object The object for `key`. A strong reference to the object is maintained by BEObject.
...
/**
 ...
 This method enables usage of literal syntax on `BEObject`.
 ...
 */
- (BERelation *)relationForKey:(NSString *)key;
...
/**
 ...
 @deprecated Please use `BEObject.-relationForKey:` instead.
 */
- (BERelation *)relationforKey:(NSString *)key PARSE_DEPRECATED("Please use -relationForKey: instead.");
...
/**
 Saves the `BEObject` *asynchronously*.
...
/**
 Saves the `BEObject` *asynchronously* and executes the given callback block.
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)saveAllInBackground:(nullable NSArray<BEObject *> *)objects;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSNumber *> *)deleteAllInBackground:(nullable NSArray<BEObject *> *)objects;
...
/**
 Gets whether the `BEObject` has been fetched.

 @return `YES` if the BEObject is new or has been fetched or refreshed, otherwise `NO`.
 */
...
/**
 Refreshes the BEObject with the current data from the server.
...
/**
 *Synchronously* refreshes the `BEObject` with the current data from the server and sets an error if it occurs.
...
/**
 *Asynchronously* refreshes the `BEObject` and executes the given callback block.

 @param block The block to execute.
 The block should have the following argument signature: `^(BEObject *object, NSError *error)`
...
/**
 Fetches the `BEObject` *asynchronously* and sets it as a result for the task.

 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof BEObject *> *)fetchInBackground;

/**
 Fetches the `BEObject` *asynchronously* and executes the given callback block.

 @param block The block to execute.
 It should have the following argument signature: `^(BEObject *object, NSError *error)`.
 */
- (void)fetchInBackgroundWithBlock:(nullable PFObjectResultBlock)block;

/**
 Fetches the `BEObject` data *asynchronously* if `dataAvailable` is `NO`,
 then sets it as a result for the task.

 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof BEObject *> *)fetchIfNeededInBackground;

/**
 Fetches the `BEObject` data *asynchronously* if `dataAvailable` is `NO`, then calls the callback block.
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSArray<__kindof BEObject *> *> *)fetchAllInBackground:(nullable NSArray<BEObject *> *)objects;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
+ (BFTask<NSArray<__kindof BEObject *> *> *)fetchAllIfNeededInBackground:(nullable NSArray<BEObject *> *)objects;
 ...
 *Asynchronously* loads data from the local datastore into this object,
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<__kindof BEObject *> *)fetchFromLocalDatastoreInBackground;
...
/**
 Deletes the `BEObject` *asynchronously*.
...
/**
 Deletes the `BEObject` *asynchronously* and executes the given callback block.
 ...
 *Asynchronously* stores the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (BFTask<NSNumber *> *)pinAllInBackground:(nullable NSArray<BEObject *> *)objects;
 ...
 *Asynchronously* stores the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (void)pinAllInBackground:(nullable NSArray<BEObject *> *)objects block:(nullable PFBooleanResultBlock)block;
 ...
 */
+ (BFTask<NSNumber *> *)pinAllInBackground:(nullable NSArray<BEObject *> *)objects withName:(NSString *)name;
 ...
 */
+ (void)pinAllInBackground:(nullable NSArray<BEObject *> *)objects
 ...
 *Asynchronously* removes the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (BFTask<NSNumber *> *)unpinAllInBackground:(nullable NSArray<BEObject *> *)objects;
 ...
 *Asynchronously* removes the objects and every object they point to in the local datastore, recursively,
 ...
 @see BEObjectDefaultPin
 */
+ (void)unpinAllInBackground:(nullable NSArray<BEObject *> *)objects block:(nullable PFBooleanResultBlock)block;
 ...
 */
+ (BFTask<NSNumber *> *)unpinAllInBackground:(nullable NSArray<BEObject *> *)objects withName:(NSString *)name;
 ...
 */
+ (void)unpinAllInBackground:(nullable NSArray<BEObject *> *)objects
                    withName:(NSString *)name
                       block:(nullable PFBooleanResultBlock)block;
