 ...
 */
@interface BEACL : NSObject <NSCopying, NSCoding>
 ...
 */
+ (instancetype)ACLWithUser:(BEUser *)user;
...
/**
 ...
 @param user The user to assign access.
 */
- (void)setReadAccess:(BOOL)allowed forUser:(BEUser *)user;
 ...
 */
- (BOOL)getReadAccessForUser:(BEUser *)user;
...
/**
 ...
 @param user The user to assign access.
 */
- (void)setWriteAccess:(BOOL)allowed forUser:(BEUser *)user;
 ...
 */
- (BOOL)getWriteAccessForUser:(BEUser *)user;
...
/**
 ...
 @return `YES` if the role has read access, otherwise `NO`.
 */
- (BOOL)getReadAccessForRole:(BERole *)role;
 ...
 */
- (void)setReadAccess:(BOOL)allowed forRole:(BERole *)role;
 ...
 */
- (BOOL)getWriteAccessForRole:(BERole *)role;
...
/**
 ...
 @param role The role to assign access.
 */
- (void)setWriteAccess:(BOOL)allowed forRole:(BERole *)role;
 ...
 */
+ (void)setDefaultACL:(nullable BEACL *)acl withAccessForCurrentUser:(BOOL)currentUserAccess;
