...
typedef void (^PFObjectResultBlock)(BEObject *_Nullable object,  NSError *_Nullable error);
typedef void (^PFSetResultBlock)(NSSet *_Nullable channels, NSError *_Nullable error);
typedef void (^PFUserResultBlock)(BEUser *_Nullable user, NSError *_Nullable error);
